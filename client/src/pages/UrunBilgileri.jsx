...
/**
 * Team leader's alt görev editor for one product.
 *
 ...
 *
 * Loads lazily: the section only mounts once its card is expanded, so opening
 * the page doesn't fire a request per product.
 */
function SubtaskSection({ projectId, designers }) {
        ...
        <div className="overflow-hidden">
          <div className="border-t border-dashed bg-muted/15 px-4 pb-4 pt-3.5">
            ...
            {canEdit && open && !project.__seed && (
              <SubtaskSection projectId={project.id} designers={designers} />
            )}
          </div>
        </div>
      </div>
