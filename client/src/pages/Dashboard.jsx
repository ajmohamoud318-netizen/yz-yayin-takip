...
import YearPlanGantt from '../components/YearPlanGantt.jsx'
  ...
  return (
    ...
    >
      ...
      {/* Yıllık plan chart. A transient API error (e.g. a 30-second poll
          ...
          load fallback. The shared <YearPlanGantt> handles skeleton +
          empty + chart + Tarihsiz rendering; the page keeps error UX. */}
